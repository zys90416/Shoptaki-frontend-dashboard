	...
	return (
		<div className='DashBoard UserDetails SocialApplications'>
			...
			<div>
				...
				&nbsp;&nbsp;
				<span className='userdetail-text'>Social Applications</span>
				<hr />
				<div className='document-wrap'></div>
			</div>

			<div className='flex'>
				<AppBox app_name='Facebook' app_id='518802205854801' app_type='Social' />
				<AppBox app_name='Twitter' app_id='518802205854801' app_type='Social' />
				<AppBox app_name='Instagram' app_id='518802205854801' app_type='Social' />
			</div>
